          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 '>
            ...
            <div className='flex flex-col-reverse items-center justify-center gap-5'>
              <div className='flex flex-col items-center justify-center w-60 h-auto'>
                <FaUserTie color='oklch(70.5% 0.213 47.604)' size={25} />
              ...
              <div className='flex flex-col items-center justify-center w-60 h-auto'>
                <TbTruckDelivery color='oklch(70.5% 0.213 47.604)' size={25} />
              ...
              <div className='flex flex-col items-center justify-center w-60 h-auto'>
                <FaShieldAlt color='oklch(70.5% 0.213 47.604)' size={25} />
            ...
            <div className='w-70 relative h-75 self-center bg-gray-400'>
              <div className='w-70 h-75 absolute bg-orange-300 left-5 top-5 ' />
              <Image
                src={'/images/why.jpg'}
            ...
            {/* sec col */}
             ...
             <div className='flex flex-col items-center justify-center gap-5'>
              <div className='flex flex-col items-center justify-center w-60 h-auto'>
                <FaDollarSign color='oklch(70.5% 0.213 47.604)' size={25} />
              ...
              <div className='flex flex-col items-center justify-center w-60 h-auto'>
                <FaSmile color='oklch(70.5% 0.213 47.604)' size={25} />
              ...
              <div className='flex flex-col items-center justify-center w-60 h-auto'>
                <FaBoxes color='oklch(70.5% 0.213 47.604)' size={25} />
